...
export class VertexShurikenParticleMesh extends VertexShuriKenParticle {
  ...
  */
	static __init__(): void {
		VertexShurikenParticleMesh._vertexDeclaration = new VertexDeclaration(200, [new VertexElement(0, VertexElementFormat.Vector3, VertexShuriKenParticle.PARTICLE_POSITION0),
		...
		new VertexElement(108, VertexElementFormat.Vector4, VertexShuriKenParticle.PARTICLE_STARTSPEED),
		new VertexElement(124, VertexElementFormat.Vector4, VertexShuriKenParticle.PARTICLE_RANDOM0),
		new VertexElement(140, VertexElementFormat.Vector4, VertexShuriKenParticle.PARTICLE_RANDOM1),
		new VertexElement(156, VertexElementFormat.Vector3, VertexShuriKenParticle.PARTICLE_SIMULATIONWORLDPOSTION),//TODO:local模式下可省去内存
		new VertexElement(168, VertexElementFormat.Vector4, VertexShuriKenParticle.PARTICLE_SIMULATIONWORLDROTATION),
		new VertexElement(184,VertexElementFormat.Vector4, VertexShuriKenParticle.PARTICLE_SIMULATIONUV)]);
		...
		VertexShurikenParticleMesh._vertexInstanceParticleDeclaration = new VertexDeclaration(164, [
			...
			new VertexElement(72, VertexElementFormat.Vector4, VertexShuriKenParticle.PARTICLE_STARTSPEED),
			new VertexElement(88, VertexElementFormat.Vector4, VertexShuriKenParticle.PARTICLE_RANDOM0),
			new VertexElement(104, VertexElementFormat.Vector4, VertexShuriKenParticle.PARTICLE_RANDOM1),
			new VertexElement(120, VertexElementFormat.Vector3, VertexShuriKenParticle.PARTICLE_SIMULATIONWORLDPOSTION),//TODO:local模式下可省去内存
			new VertexElement(132, VertexElementFormat.Vector4, VertexShuriKenParticle.PARTICLE_SIMULATIONWORLDROTATION),
			new VertexElement(148,VertexElementFormat.Vector4, VertexShuriKenParticle.PARTICLE_SIMULATIONUV)
		]);
	}
