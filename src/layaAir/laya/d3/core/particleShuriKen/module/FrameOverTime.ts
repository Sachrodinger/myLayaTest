...
export class FrameOverTime implements IClone {
	...
	cloneTo(destObject: any): void {
		...
		(this._overTime) &&(destFrameOverTime._overTime)&& (this._overTime.cloneTo(destFrameOverTime._overTime));
		destFrameOverTime._constantMin = this._constantMin;
		destFrameOverTime._constantMax = this._constantMax;
		(this._overTimeMin) &&(destFrameOverTime._overTimeMin)&& (this._overTimeMin.cloneTo(destFrameOverTime._overTimeMin));
		(this._overTimeMax) &&(destFrameOverTime._overTimeMax)&& (this._overTimeMax.cloneTo(destFrameOverTime._overTimeMax));
	}
